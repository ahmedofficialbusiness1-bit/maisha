  ...
  return (
    <div className="flex flex-col gap-4 text-white">
      <div>
        ...
        <p className="text-muted-foreground">Tools for managing the game economy.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-gray-800/60 border-gray-700">
          <CardHeader>
            ...
            <CardDescription>
              Use this tool to simulate and understand commodity price changes based on various factors.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
