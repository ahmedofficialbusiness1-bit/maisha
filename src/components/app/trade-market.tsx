                    ...
                    {products.map(product => {
                        return (
                            ...
                            <div className="h-5 w-5 flex items-center justify-center mb-2">
                                {React.cloneElement(product.icon as React.ReactElement, { className: "h-full w-full" })}
                            </div>
            ...
            <div className='md:col-span-2 flex flex-col gap-4'>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="text-center">
                        {React.cloneElement(selectedProduct.icon as React.ReactElement, { className: "h-12 w-12 mx-auto mb-2" })}
