...
const initialInventoryItems: InventoryItem[] = [
    ...
    { item: 'Maji', quantity: 15000, marketPrice: 3 },
    { item: 'Mbegu', quantity: 8000, marketPrice: 25 },
    { item: 'Yai', quantity: 25000, marketPrice: 12 },
    { item: 'Bwawa', quantity: 10, marketPrice: 500 },
    { item: 'Boat', quantity: 5, marketPrice: 1000 },
    { item: 'Mbao', quantity: 500, marketPrice: 40 },
    { item: 'Matofali', quantity: 1000, marketPrice: 25 },
    { item: 'Nondo', quantity: 200, marketPrice: 50 },
    { item: 'Zege', quantity: 100, marketPrice: 70 },
    { item: 'A1 Mashine', quantity: 10, marketPrice: 2000 },
    { item: 'A2 Mashine', quantity: 10, marketPrice: 2100 },
    { item: 'A3 Mashine', quantity: 10, marketPrice: 2200 },
    { item: 'A4 Mashine', quantity: 10, marketPrice: 2300 },
    { item: 'A5 Mashine', quantity: 10, marketPrice: 2400 },
    { item: 'B1 Mashine', quantity: 10, marketPrice: 1000 },
    { item: 'B2 Mashine', quantity: 10, marketPrice: 1100 },
    { item: 'B3 Mashine', quantity: 10, marketPrice: 1200 },
    { item: 'B4 Mashine', quantity: 10, marketPrice: 1300 },
    { item: 'B5 Mashine', quantity: 10, marketPrice: 1400 },
    { item: 'B6 Mashine', quantity: 10, marketPrice: 1500 },
    { item: 'B7 Mashine', quantity: 10, marketPrice: 1600 },
    { item: 'C1 Mashine', quantity: 10, marketPrice: 1800 },
    { item: 'C2 Mashine', quantity: 10, marketPrice: 1900 },
    { item: 'K1 Mashine', quantity: 2, marketPrice: 2500 },
    ...
    { item: 'Leseni B1', quantity: 10, marketPrice: 500 },
    { item: 'Leseni B2', quantity: 10, marketPrice: 550 },
    { item: 'Leseni B3', quantity: 10, marketPrice: 600 },
    { item: 'Leseni B4', quantity: 10, marketPrice: 650 },
    { item: 'Leseni B5', quantity: 10, marketPrice: 700 },
    { item: 'Leseni B6', quantity: 10, marketPrice: 750 },
    { item: 'Leseni B7', quantity: 10, marketPrice: 800 },
    { item: 'Shaba', quantity: 100, marketPrice: 200 },
    { item: 'Miti', quantity: 1000, marketPrice: 0.5 },
    { item: 'Saruji', quantity: 1000, marketPrice: 60 },
    { item: 'Chuma', quantity: 200, marketPrice: 150 },
    { item: 'Kokoto', quantity: 1000, marketPrice: 30 },
    { item: 'Mawe', quantity: 1000, marketPrice: 0.2 },
    { item: 'Umeme', quantity: 10000, marketPrice: 100 },
    { item: 'Mchanga', quantity: 1000, marketPrice: 15 },
    { item: 'Madini ya chuma', quantity: 1000, marketPrice: 0.9 },
];

const initialPlayerListings: PlayerListing[] = [
    { id: 1, commodity: 'Maji', seller: 'Flexy suyo', quantity: 450, price: 3, avatar: 'https://picsum.photos/seed/flexy/40/40', quality: 1, imageHint: 'player avatar' },
    { id: 2, commodity: 'Yai', seller: 'MKG CIE', quantity: 100, price: 12, avatar: 'https://picsum.photos/seed/mkg/40/40', quality: 0, imageHint: 'company logo' },
];
