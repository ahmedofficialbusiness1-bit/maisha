...
const initialInventoryItems: InventoryItem[] = [
  { item: 'Maji', quantity: 15000, marketPrice: 0.1 },
  { item: 'Mbegu', quantity: 8000, marketPrice: 0.7 },
  { item: 'Yai', quantity: 25000, marketPrice: 1.5 },
  { item: 'Bwawa', quantity: 10, marketPrice: 250 },
  { item: 'Boat', quantity: 5, marketPrice: 500 },
  { item: 'Mbao', quantity: 500, marketPrice: 6 },
  { item: 'Matofali', quantity: 1000, marketPrice: 1 },
  { item: 'Nondo', quantity: 200, marketPrice: 7 },
  { item: 'Zege', quantity: 100, marketPrice: 5 },
  { item: 'A1 Mashine', quantity: 10, marketPrice: 2300 },
  { item: 'A2 Mashine', quantity: 10, marketPrice: 2600 },
  { item: 'A3 Mashine', quantity: 10, marketPrice: 3200 },
  { item: 'A4 Mashine', quantity: 10, marketPrice: 3600 },
  { item: 'A5 Mashine', quantity: 10, marketPrice: 4200 },
  { item: 'B1 Mashine', quantity: 10, marketPrice: 1200 },
  { item: 'B2 Mashine', quantity: 10, marketPrice: 1300 },
  { item: 'B3 Mashine', quantity: 10, marketPrice: 1400 },
  { item: 'B4 Mashine', quantity: 10, marketPrice: 1500 },
  { item: 'B5 Mashine', quantity: 10, marketPrice: 1600 },
  { item: 'B6 Mashine', quantity: 10, marketPrice: 1700 },
  { item: 'B7 Mashine', quantity: 10, marketPrice: 1800 },
  { item: 'C1 Mashine', quantity: 10, marketPrice: 3000 },
  { item: 'C2 Mashine', quantity: 10, marketPrice: 5000 },
  { item: 'K1 Mashine', quantity: 2, marketPrice: 1700 },
  { item: 'K2 Mashine', quantity: 2, marketPrice: 6000 },
  { item: 'K3 Mashine', quantity: 2, marketPrice: 8000 },
  { item: 'K4 Mashine', quantity: 2, marketPrice: 12000 },
  { item: 'K5 Mashine', quantity: 2, marketPrice: 15000 },
  { item: 'K6 Mashine', quantity: 2, marketPrice: 17000 },
  { item: 'K7 Mashine', quantity: 2, marketPrice: 20000 },
  { item: 'Leseni B1', quantity: 10, marketPrice: 5000 },
  { item: 'Leseni B2', quantity: 10, marketPrice: 5100 },
  { item: 'Leseni B3', quantity: 10, marketPrice: 5200 },
  { item: 'Leseni B4', quantity: 10, marketPrice: 5300 },
  { item: 'Leseni B5', quantity: 10, marketPrice: 5400 },
  { item: 'Leseni B6', quantity: 10, marketPrice: 5500 },
  { item: 'Leseni B7', quantity: 10, marketPrice: 5600 },
  { item: 'Shaba', quantity: 100, marketPrice: 100 },
  { item: 'Miti', quantity: 1000, marketPrice: 0.5 },
  { item: 'Saruji', quantity: 1000, marketPrice: 3 },
  { item: 'Chuma', quantity: 200, marketPrice: 8 },
  { item: 'Kokoto', quantity: 1000, marketPrice: 1.8 },
  { item: 'Mawe', quantity: 1000, marketPrice: 0.2 },
  { item: 'Umeme', quantity: 10000, marketPrice: 0.2 },
  { item: 'Mchanga', quantity: 1000, marketPrice: 0.8 },
  { item: 'Madini ya chuma', quantity: 1000, marketPrice: 0.9 },
];

const initialPlayerListings: PlayerListing[] = [
    { id: 1, commodity: 'Maji', seller: 'Flexy suyo', quantity: 450, price: 0.1, avatar: 'https://picsum.photos/seed/flexy/40/40', quality: 1, imageHint: 'player avatar' },
    { id: 2, commodity: 'Yai', seller: 'MKG CIE', quantity: 100, price: 1.5, avatar: 'https://picsum.photos/seed/mkg/40/40', quality: 0, imageHint: 'company logo' },
];
