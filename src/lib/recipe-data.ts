...
export const recipes: Recipe[] = [
  ...
  // Kiwanda cha Mashine
  { id: 'a1_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'A1 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'a2_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'A2 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'a3_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'A3 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'a4_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'A4 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'a5_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'A5 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'b1_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'B1 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'b2_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'B2 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'b3_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'B3 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'b4_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'B4 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'b5_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'B5 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'b6_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'B6 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'b7_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'B7 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'c1_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'C1 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  { id: 'c2_mashine', buildingId: 'kiwanda_cha_mashine', output: { name: 'C2 Mashine', quantity: 1 }, inputs: machineRecipeInputs },
  ...
  { id: 'gari_ya_kifahari', buildingId: 'kiwanda_cha_gari', output: { name: 'Gari ya kifahari', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 2 }, { name: 'Engine', quantity: 4 }, { name: 'Motor', quantity: 4 }, { name: 'Luxury Interior', quantity: 3 }, { name: 'Car Body', quantity: 1 }, { name: 'Dhahabu', quantity: 4 }, { name: 'Tanzanite', quantity: 2 }] },
  ...
  { id: 'pikipiki_ya_kifahari', buildingId: 'kiwanda_cha_pikipiki', output: { name: 'Pikipiki ya Kifahari', quantity: 1 }, inputs: [{ name: 'Engine', quantity: 4 }, { name: 'Motor', quantity: 4 }, { name: 'Luxury Interior', quantity: 2 }, { name: 'Bike Body', quantity: 1 }, { name: 'Dhahabu', quantity: 2 }, { name: 'Ruby', quantity: 4 }] },
