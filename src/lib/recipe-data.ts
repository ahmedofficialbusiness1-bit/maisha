...
export const recipes: Recipe[] = [
  ...
  { id: 'bike_body', buildingId: 'kiwanda_cha_spare', output: { name: 'Bike Body', quantity: 1 }, inputs: [{ name: 'Chuma', quantity: 5 }, { name: 'Maji', quantity: 2 }, { name: 'Umeme', quantity: 2 }, { name: 'Mbao', quantity: 1 }], cost: 10000, requiredWorkers: [] },
  ...
  { id: 'bull_dozer_body', buildingId: 'kiwanda_cha_spare', output: { name: 'Bull dozer body', quantity: 1 }, inputs: [{ name: 'Chuma', quantity: 50 }, { name: 'Maji', quantity: 10 }, { name: 'Umeme', quantity: 10 }, { name: 'Mbao', quantity: 5 }], cost: 100000, requiredWorkers: [] },
  { id: 'truck_body', buildingId: 'kiwanda_cha_spare', output: { name: 'Truck body', quantity: 1 }, inputs: [{ name: 'Chuma', quantity: 30 }, { name: 'Maji', quantity: 8 }, { name: 'Umeme', quantity: 8 }, { name: 'Mbao', quantity: 4 }], cost: 80000, requiredWorkers: [] },
  { id: 'bodi_ya_ndege', buildingId: 'kiwanda_cha_spare', output: { name: 'Bodi ya Ndege', quantity: 1 }, inputs: [{ name: 'Chuma', quantity: 100 }, { name: 'Maji', quantity: 20 }, { name: 'Umeme', quantity: 20 }, { name: 'Mbao', quantity: 10 }], cost: 250000, requiredWorkers: [] },
  { id: 'bodi_ya_meli', buildingId: 'kiwanda_cha_spare', output: { name: 'Bodi ya Meli', quantity: 1 }, inputs: [{ name: 'Chuma', quantity: 200 }, { name: 'Maji', quantity: 40 }, { name: 'Umeme', quantity: 40 }, { name: 'Mbao', quantity: 20 }], cost: 500000, requiredWorkers: [] },

  // Vehicle Chain - Assembly
  { id: 'bull_dozer', buildingId: 'kiwanda_cha_gari', output: { name: 'Bull Dozer', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 1 }, { name: 'Engine', quantity: 1 }, { name: 'Motor', quantity: 1 }, { name: 'Interior', quantity: 1 }, { name: 'Bull dozer body', quantity: 1 }, { name: 'Umeme', quantity: 10 }], cost: 500000, requiredWorkers: [] },
  { id: 'lori', buildingId: 'kiwanda_cha_gari', output: { name: 'Lori', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 1 }, { name: 'Engine', quantity: 1 }, { name: 'Motor', quantity: 1 }, { name: 'Interior', quantity: 1 }, { name: 'Truck body', quantity: 1 }, { name: 'Umeme', quantity: 10 }], cost: 400000, requiredWorkers: [] },
  { id: 'gari_ya_kifahari', buildingId: 'kiwanda_cha_gari', output: { name: 'Gari ya kifahari', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 1 }, { name: 'Engine', quantity: 1 }, { name: 'Motor', quantity: 1 }, { name: 'Luxury Interior', quantity: 1 }, { name: 'Car Body', quantity: 1 }, { name: 'Umeme', quantity: 10 }], cost: 600000, requiredWorkers: [] },
  { id: 'gari', buildingId: 'kiwanda_cha_gari', output: { name: 'Gari', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 1 }, { name: 'Engine', quantity: 1 }, { name: 'Motor', quantity: 1 }, { name: 'Interior', quantity: 1 }, { name: 'Car Body', quantity: 1 }, { name: 'Umeme', quantity: 10 }], cost: 300000, requiredWorkers: [] },
  { id: 'pikipiki_ya_kifahari', buildingId: 'kiwanda_cha_pikipiki', output: { name: 'Pikipiki ya Kifahari', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 1 }, { name: 'Engine', quantity: 1 }, { name: 'Motor', quantity: 1 }, { name: 'Luxury Interior', quantity: 1 }, { name: 'Bike Body', quantity: 1 }, { name: 'Umeme', quantity: 5 }], cost: 250000, requiredWorkers: [] },
  { id: 'pikipiki', buildingId: 'kiwanda_cha_pikipiki', output: { name: 'Pikipiki', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 1 }, { name: 'Engine', quantity: 1 }, { name: 'Motor', quantity: 1 }, { name: 'Interior', quantity: 1 }, { name: 'Bike Body', quantity: 1 }, { name: 'Umeme', quantity: 5 }], cost: 150000, requiredWorkers: [] },
  { id: 'ndege', buildingId: 'kiwanda_cha_ndege', output: { name: 'Ndege', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 1 }, { name: 'Engine', quantity: 2 }, { name: 'Motor', quantity: 4 }, { name: 'Interior', quantity: 1 }, { name: 'Bodi ya Ndege', quantity: 1 }, { name: 'Umeme', quantity: 50 }], cost: 2000000, requiredWorkers: [] },
  { id: 'ndege_ya_kifahari', buildingId: 'kiwanda_cha_ndege', output: { name: 'Ndege ya kifahari', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 1 }, { name: 'Engine', quantity: 4 }, { name: 'Motor', quantity: 8 }, { name: 'Luxury Interior', quantity: 1 }, { name: 'Bodi ya Ndege', quantity: 1 }, { name: 'Umeme', quantity: 100 }], cost: 5000000, requiredWorkers: [] },
  { id: 'meli', buildingId: 'kiwanda_cha_meli', output: { name: 'Meli', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 1 }, { name: 'Engine', quantity: 4 }, { name: 'Motor', quantity: 8 }, { name: 'Interior', quantity: 1 }, { name: 'Bodi ya Meli', quantity: 1 }, { name: 'Umeme', quantity: 200 }], cost: 10000000, requiredWorkers: [] },
  { id: 'meli_ya_kifahari', buildingId: 'kiwanda_cha_meli', output: { name: 'Meli ya kifahari', quantity: 1 }, inputs: [{ name: 'Dashboard', quantity: 1 }, { name: 'Engine', quantity: 8 }, { name: 'Motor', quantity: 16 }, { name: 'Luxury Interior', quantity: 1 }, { name: 'Bodi ya Meli', quantity: 1 }, { name: 'Umeme', quantity: 400 }], cost: 30000000, requiredWorkers: [] },
];
