...
import { getInitialUserData, saveGameState } from '@/services/game-service';
...
export default function LoginPage() {
  ...
  const handleLogin = () => {
    ...
    const newUserData = getInitialUserData();
    saveGameState(newUserData);
    ...
    <main className="flex flex-col items-center justify-center min-h-screen p-4 text-white bg-gray-900">
      <Card className="w-full max-w-sm bg-gray-800/60 border-gray-700">
        <CardHeader className="text-center">
          ...
          <CardDescription>Sign in to continue your economic conquest.</CardDescription>
        </CardHeader>
        <CardContent>
          <Button className="w-full bg-white text-black hover:bg-gray-200" onClick={handleLogin}>
